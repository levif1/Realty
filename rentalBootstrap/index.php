...
<div class="container-fluid overallPadding">
      <div class="row text-center infoPadding">
        <div class="col-md-12 col-lg-6 customImage1 contentPadding">
          <img src="resources/kitchen.jpg" class="img-fluid" alt="Grocery Basket">
        </div>
      ...
      <div class="row infoPadding">
        ...
        <div class="col-md-12 col-lg-6 customImage2 contentPadding">
          <img src="resources/house.jpg" class="img-fluid" alt="Home">
        </div>
      </div>
    </div>
</div>
...
<div class="footerContainer">
  <div class="footerSpacing row">
    ...
    <div class="footerText col-xs-12 col-sm-2">Resident Login</div>
      <a class="break d-none d-sm-block">|</a>
    <div class="footerText col-xs-12 col-sm-2">Application Login</div>
      <a class="break d-none d-sm-block">|</a>
    <div class="footerText col-xs-12 col-sm-2">Contact Us</div>
      <a class="break d-none d-sm-block">|</a>
    <div class="footerText col-xs-12 col-sm-2">Create an Account</div>
      <a class="break d-none d-sm-block">|</a>
  </div>
</div>
